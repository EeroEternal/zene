...
### P7.1 TUI（已移除；本地交互为 CLI REPL，产品 UI 为 Cloud Console，见 `docs/TUI_MIGRATION.md`）
...
| P8 Web Agent | [x] | 已退役：本地 gateway / web-agent 删除；CLI 默认 REPL；产品 UI 为 Cloud Console（Atelier） |

*最后更新：2026-07-25（Atelier Cloud Console；移除本地 Web Agent）*
