...
3. **Wave 11：ModelExecutor 与 runtime crate（P1）**
   ...
   - 继续抽离 ChatClient 持有关系、overflow 执行编排、Context water 写入和 usage 事件编排；
